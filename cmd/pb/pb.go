...
func (pb *ProgressBar) Start() *ProgressBar {
	// log.Println("Debug From 'Start func ....'")
...
// This function add current values as bytes
func (pb *ProgressBar) Add(add int) int {
	// log.Println("Debug From 'Add func ....'", pb.Add64(int64(add)))
...
func (pb *ProgressBar) refresher() {
	// log.Println("Debug From 'refresher func ....'")
	for {
		select {
		case <-pb.finish:
			return
